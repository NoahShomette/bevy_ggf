...
engine. This framework is intended to provide a massive and modular jumpstart to anyone who intends to make a tactics game in
the style of Advanced Wars and Final Fantasy. Long term goals are to support larger and more strategy style games like Civilization.

# Crate Status

This crate is being actively developed however it is still very early in development. Any advice, opinions, pull requests,
